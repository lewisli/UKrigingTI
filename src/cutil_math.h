...
// negate
inline __host__ __device__ short2 operator-(short2 &a)
{
    return make_short2(-a.x, -a.y);
}

// addition
inline __host__ __device__ short2 operator+(short2 a, short2 b)
{
    return make_short2(a.x + b.x, a.y + b.y);
}
inline __host__ __device__ void operator+=(short2 &a, short2 b)
{
    a.x += b.x; a.y += b.y;
}
...
inline __host__ __device__ short2 operator*(short2 a, ushort s)
{
    return make_short2(a.x * s, a.y * s);
}
inline __host__ __device__ short2 operator*(ushort s, short2 a)
{
    return make_short2(a.x * s, a.y * s);
}
inline __host__ __device__ void operator*=(short2 &a, ushort s)
{
    a.x *= s; a.y *= s;
}
